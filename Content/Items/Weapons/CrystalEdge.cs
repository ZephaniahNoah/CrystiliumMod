	...
	public class CrystalEdge : ModItem
	{
		...
		public override void MeleeEffects(Player player, Rectangle hitbox)
		{
			if (Main.rand.Next(5) == 0)
			{
				...
				vel *= 1f;
				Projectile.NewProjectile(player/*Item*/.GetSource_ItemUse(Item), hitbox.X + Main.rand.Next(40), hitbox.Y + Main.rand.Next(40), vel.X, vel.Y, Mod.Find<ModProjectile>("Shatter" + (1 + Main.rand.Next(0, 3))).Type, Item.damage, 0, Main.myPlayer);
			}
		}
